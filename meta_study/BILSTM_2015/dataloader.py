...
class LSTMDataloader(Dataset):
    ...
    def __init__(self,root,ToFilter=False,AddMagnitude=False,AddGyro=True,normalize=True,window_size=500,stride=1,windowed_labels=True,relaxed_labels=False,sensor='all') -> None:
        self.root = root
